{
    ...
    "train_data_path": "../datasets/covr_scfg_gen/covr_scfg_gen.all.jsonl",
    "validation_data_path": "@../datasets/covr_scfg_gen/covr_scfg_gen.all.jsonl",  // '@' is a hack to indicate this is validation
    "dataset_reader": {
